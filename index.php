...
<head>
  ...
  <title>Welcome to LA MAF Bank</title>
    ...
    <div class="container d-flex justify-content-between">
      ...
      <div class="logo">
        <!-- Uncomment below if you prefer to use an text logo -->
         <h1><a href="index.php">LA MAF BANK</a></h1> 
  ...
  <section id="hero" class="clearfix">
    <div class="container" data-aos="fade-up">
      ...
      <div class="hero-info" data-aos="zoom-in" data-aos-delay="100">
        <h2>Welcome to <br><span>LA MAF Bank</span><br>Services!</h2>
        <div>
  ...
  <main id="main">
    ...
    <section id="about">
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          <h3>About Us</h3>
          <p>LA MAF BANK principal objective was to create a development financial institution for providing medium-term and long-term project financing to rural communities with a view to developing the rural economy by providing, for the purpose of development of agriculture, trade, commerce, industry and other productive activities in the rural areas, credit and other facilities, particularly to small and marginal farmers, agricultural labourers, artisans and small entrepreneurs, and for matters connected therewith and incidental thereto.</p>
        </header>
        ...
        <div class="row about-container">
          ...
          <div class="col-lg-6 content order-lg-1 order-2">
            <p>
              For La MAF BANK, the interests of the common man havealways remained at the core of its business.With a customer-centric approach, the Bank has designed products and services to meet the expectations of the financial life cycle of its valued clientele. Keeping pace with the transforming landscape of the Cameroon economy, LA MAF has broadened its digital base in the recent years. 
            </p>

            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              <div class="icon"><i class="bi bi-card-checklist"></i></div>
              <h4 class="title"><a href="">Quick Start Account</a></h4>
              <p class="description">But this requires a simple and easy distinction. For free time with our power of choice</p>
            </div>

            <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
              <div class="icon"><i class="bi bi-brightness-high"></i></div>
              <h4 class="title"><a href="">Instant Fund Transfer</a></h4>
              <p class="description">Excepteur cupidatat blacks are not excepteur, is soothing to the soul, that is, they are my toil, they deserted the general is to blame that services should be</p>
            </div>

            <div class="icon-box" data-aos="fade-up" data-aos-delay="300">
              <div class="icon"><i class="bi bi-calendar4-week"></i></div>
              <h4 class="title"><a href="">Pain System</a></h4>
              <p class="description">Minim will I come, who shall take advantage from it, but for to exercise, school district  LIGHT UP out of work</p>
            </div>
    ...
    <section id="services" class="section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          <h3>Notice</h3>
          <p>Here are some latest updates from LA MAF Bank. Read this notices carefully</p>
        </header>
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-6 col-lg-5" data-aos="zoom-in" data-aos-delay="100">
            <div class="box">
              ...
              <p class="description">LMB never asks for your Card/PIN/OTP/CVV details on phone, message or email. Please do not click on links received on your email or mobile asking your Bank/Card details. </p>
            </div>
          </div>
          <div class="col-md-6 col-lg-5" data-aos="zoom-in" data-aos-delay="200">
            <div class="box">
              ...
              <p class="description">  Dear Customer, if you have donated for PM CARES through LA MAF Internet Banking, you can download the Receipt from PMCares portal of govt. using the reference number available with you. </p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-5" data-aos="zoom-in" data-aos-delay="100">
            <div class="box">
              ...
              <h4 class="title"><a href="">LA MAF BANKING</a></h4>
              <p class="description"> Have you tried our new simplified and intuitive business banking platform? Log in to LA MAF bank to avail business banking services</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-5" data-aos="zoom-in" data-aos-delay="200">
            <div class="box">
...
-->
        ...
        <div class="row row-eq-height justify-content-center">
          ...
          <div class="col-lg-4 mb-4">
            <div class="card" data-aos="zoom-in" data-aos-delay="200">
              ...
              <div class="card-body">
                <h5 class="card-title">LA MAF Bank Card</h5>
                <p class="card-text">20% discount of Flipart products.Pay using LA MAF Bank card.</p>
                <a href="#" class="readmore">Read more </a>
              </div>
            </div>
          </div>
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="testimonial-item">
                    ...
                    <h3>Alain Dominique</h3>
                    <h4>CEO &amp; Founder</h4>
                    <p>
                      I am very happy with the service which MLC provides. The coordinator Simone Florence was actively involved in the entire procedure. Her proactive approach in regards with the communication with banker, timely feedback really was a tremendous great help for me. Her excellence in communication, coordination, timely feedback was always a great support and help. Thank you very much once again for all your efforts and help. You are doing great Job and keep up the good work.
                ...
                <div class="swiper-slide">
                  <div class="testimonial-item">
                    ...
                    <h3>Micheline Friede </h3>
                    <h4>Entrepreneur</h4>
                    <p>
                      Friede did a good job and ensured compliance with the loan process and provided the right guidance for Balance Transfer of loan.
                    </p>
                  </div>
                </div><!-- End testimonial item -->
          ...
          <div class="col-lg-6">
            <div class="row">
              <div class="col-md-5 info">
                ...
                <p>ALBERT FRANCK, Douala</p>
              </div>
              <div class="col-md-4 info">
                <i class="bi bi-envelope"></i>
                <p>albertfrank0604@google.com</p>
              </div>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-info">
            <h3>LA MAF BANK</h3>
            <p>I joined LMB in May 2021. Since then, I have been a Credit Officer and currently I am in Global Markets as a Dealer. Working in the biggest rural bank in Cameroon is a dream come true. One gets hands on experience in global markets, currency, equity and bonds. </p>
          </div>
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            Littoral ESEKA<br>
            P.O BOX 3015 <br>
            <strong>Phone:</strong> +237-693-897-634<br>
            <strong>Email:</strong> albertfrank0604@gmail.com<br>
            </p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; 2021 Copyright <strong>Albert Frank</strong>. All Rights Reserved
      </div>
    </div>
  </footer><!-- End Footer -->
