...
<head>
  ...
  <title>LA MAF | Manager Login </title>
...
<body>
    <nav style="width: 100%; background-color: #009df8; height: 10vh; color: white; padding:10px 10px 10px 10px;"> <center><h2>LA MAF Bank Login</h2></center></nav>
  <main>
