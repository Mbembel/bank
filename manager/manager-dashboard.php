...
<head>
  ...
  <title>LA MAF Bank | Employee</title>
                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                                ...
                                <div class="tab-pane fade mb-5" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                                        ...
                                        <form class="row g-3" method="post" action="../forms/add-customer.php">
                                              ...
                                              <div class="col-md-4">
                                                <label for="inputEmail4" class="form-label" required>Select town</label>
                                                  <select class="form-select" name="state" aria-label="Default select example">
                                                        <option selected>Select Town</option>
                                                        <option value="Douala">Douala</option>
                                                        <option value="Yaounde">Yaounde</option>
                                                        <option value="Edea">Edea</option>
                                                        <option value="Bagangte">Bagangte</option>
                                                        <option value="Dibamba">Dibamba</option>
